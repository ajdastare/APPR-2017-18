...
```{r stopnja_prenaseljenosti, echo=FALSE, message=FALSE}
...
```{r prenaseljenost, echo=FALSE, message=FALSE}
kable(head(prenaseljenost))
...
```{r zemljevid_drzav, echo=FALSE, message=FALSE}
